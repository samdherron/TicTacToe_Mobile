...
public class Player1Select extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.selectplayer1_screen);


        lv = findViewById(R.id.SelectPlayer1_playerListView);
    ...
    void fillPlayerList() {
        ...
        void returnToSplash() {
            ...
            VarTempStorage.player1Name = selectedPlayer;
